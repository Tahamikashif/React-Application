...
const Footer = () => {
  ...
  return (
    <div id='f' className='w-[1120px] h-[400px] mb-8 ml-[40px] rounded-xl mt-[30px] leading-tight italic'>
      ...
      <ul>
        <p className='p-2 ml-[4px]'><input type="checkbox" checked={ticked} onChange={Tick} /> I have read the privacy and policy</p>

      </ul>

     <div className=''>
     <img className='w-[100px] h-[30px]' src="pic21.svg" alt="" />
