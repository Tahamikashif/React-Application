...
const Footer = () => {
  ...
  return (
    <div id='f' className='w-[1120px] h-[400px] mb-8 ml-[40px] rounded-xl mt-[30px] leading-tight italic'>
     ...
     <img className='w-[100px] h-[50px] mt-[50px] ml-[-255px] rounded-2xl' src="pic22.png" alt="pic2" />
     <img className='w-[100px] h-[50px] mt-[50px] ml-[-5800px] rounded-2xl' src="pic23.png" alt="pic3" />
     </div>
