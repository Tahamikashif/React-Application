  ...
  return (
    <div id='f' className='w-[1120px] h-[400px] mb-8 ml-[40px] rounded-xl mt-[30px] leading-tight italic'>
     ...
     <img className='w-[100px] h-[50px] mt-[50px] ml-[-515px] rounded-2xl' src="pic23.png" alt="pic3" />
      ...
      <div onClick={Top} className='w-[200px] cursor h-[50px] hover:scale-110 duration-700 transition-transform bg-gray-200 ml-[820px] mt-[68px] flex justify-center items-center'>
       Back to top
      </div>
