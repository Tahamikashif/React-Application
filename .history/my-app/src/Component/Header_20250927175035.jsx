    ...
    <div>
      ...
      >
        ...
        <div className="mt-[30px] text-black border-b-2 gap-4 bg-no-repeat flex-col flex justify-center items-baseline text-left text-[15px] border-amber-300">
          ...
          <Link className="hover:text-white" to={"/Mens"}>Mens</Link>
          <Link className="hover:text-white" to={"/Women"}>Womens</Link>
          <Link className="hover:text-white" to={"/Brands"}>Brands</Link>
        </div>
      </div>
    </div>
