  ...
  return (
    <div className='relative'>
      ...
      >
        ...
        <div className='mt-[-22px] absolute  text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px]'>
         ...
         <div className='mt-[-20px] ml-[10px] text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px]'>
