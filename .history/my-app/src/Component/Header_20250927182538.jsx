  ...
  return (
    <div className='relative'>
      <div className="w-[1210px] bg-gray-300 h-[30px] relative">
        ...
        <div className="mt-[-26px] ml-[20px] text-[22px] flex justify-center item-center bg-gray-400 rounded-2xl w-[22px] ">
      ...
      >
        ...
        <div className='mt-[-26px] ml-[1000px] absolute  text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px]'>
         ...
         <div className='mt-[-26px] ml-[1060px] absolute text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px]'>
