    ...
    <div className='relative'>
      ...
      >
        ...
        <div className='mt-[-25px] ml-[1000px] absolute  text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px]'>
         ...
         <div className='mt-[-25px] ml-[1060px] cursor-po absolute text-[20px] flex justify-center item-center bg-gray-400 rounded-3xl w-[24px] hover:scale-105 duration-500 transition-transform ease-in-out'>
