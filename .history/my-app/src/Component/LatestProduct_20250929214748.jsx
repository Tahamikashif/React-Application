...
const LatestProduct = () => {
  ...
  >
   ...
   <div className="relative w-[1210px] h-[300px] bg-gray-600 mt-[20px] ">
   ...
   <div className="w-[200px] h-[85px] pt-[10px]">
    <img className="w-[200px] h-[85px] object-center inline-block rounded-lg ml-[10px] hover:scale-105 duration-500" src="pic5.png" alt="" />
