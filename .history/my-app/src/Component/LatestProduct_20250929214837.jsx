...
const LatestProduct = () => {
  ...
  >
   ...
   <div className="relative w-[1210px] h-[300px] bg-gray-600 mt-[20px] grid sm:grid-cols-2 md:grid ">

   <div className="w-[200px] h-[85px] pt-[10px]">
    <img className="w-[200px] h-[85px] object-center rounded-lg ml-[10px] hover:scale-105 duration-500" src="pic4.png" alt="" />

   </div>

   <div className="w-[200px] h-[85px] pt-[10px]">
    <img className="w-[200px] h-[85px] object-center  rounded-lg ml-[10px] hover:scale-105 duration-500" src="pic5.png" alt="" />
