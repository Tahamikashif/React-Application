...
const LatestProduct = () => {
  ...
  >
    ...
    <div>
     ...
     <div>
      <div className="w-[200px] h-[80px] bg-gray-400 rounded-lg flex justify-center items-center">

       <GiPaperBagFolded className="text-[32px] flex justify-center items-center" />
