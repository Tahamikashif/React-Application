...
const LatestProduct = () => {
  ...
  >
    ...
    <div>
     ...
     <div>
      <div className="w-[200px] h-[100px] bg-gray-400 rounded-lg ">
        <div className="text-[32px] flex justify-center items-center ml-[-10px] pt-[10px]">
       <GiPaperBagFolded  />
          </div>
       <p className="ml-[30px] mt-[10px] text-[23px]">Express Delivery</p>
        <p className="ml-[30px] mt-[10px] text-[10px]">DHL express delivery worldwide</p>
