...
const LatestProduct = () => {
  ...
  >
    ...
    <div>
     ...
     <div>
      <div className="w-[200px] h-[130px] bg-gray-400 rounded-lg ">
       ...
       <p className="ml-[30px] mt-[10px] text-[19px]">Express Delivery</p>
        <p className="ml-[27px] mt-[px] text-[11px]">DHL express delivery worldwide</p>
          <p className="ml-[30px] mt-[px] text-[10px]">From our bag company</p>
