...
const LatestProduct = () => {
  ...
  >
    ...
    <div>
        ...
        <div className="ml-[480px] justify-center items-center mt-[40px] text-[30px] italic text-gray-600">
        <p>We Supported By</p>
   </div>

     <div className="grid sm:grid-cols-2 md:grid-cols-3 mt-[45px] ml-[130px]">

      <div className="w-[200px] h-[130px] bg-gray-200 rounded-lg hover:scale-105 duration-500 ">
        <div className="text-[32px] flex justify-center items-center ml-[-10px] pt-[10px]">
       <GiPaperBagFolded  />
          </div>
       <p className="ml-[22px] mt-[10px] text-[19px]">EXPRESS DELIVERY</p>
     ...
     <div>
      ...
      <MdPayments />
       ...
       <p className="ml-[30px] mt-[10px] text-[19px]">PAYMENT IN 3X</p>
        <p className="ml-[16px] mt-[px] text-[11px]">Take advantage of a payment in 3x</p>
          <p className="ml-[33px] mt-[px] text-[10px]">From our bag company</p>
      ...
      <div className="w-[200px] h-[130px] bg-gray-200 rounded-lg hover:scale-105 duration-500 ">
       ...
       <p className="ml-[30px] mt-[10px] text-[19px]">FREE RETURNS</p>
        <p className="ml-[16px] mt-[px] text-[11px]">Take advantage of a payment in 3x</p>
          <p className="ml-[33px] mt-[px] text-[10px]">From our bag company</p>
   ...
   <div className="flex justify-center mt-20">
      <motion.img
        src="https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?q=80&w=400"
        alt="bag"
        className="w-[300px] h-[300px] rounded-lg shadow-lg"
        initial={{ opacity: 0, y: 100 }}     // 👈 start hidden + neeche
        whileInView={{ opacity: 1, y: 0 }}   // 👈 scroll karne pe show
        transition={{ duration: 0.9 }}       // 👈 speed
      />
    </div>
