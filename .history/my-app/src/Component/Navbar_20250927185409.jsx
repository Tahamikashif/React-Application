  ...
  return (
    <div className='mt-[25px] ml-[18px]'>
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[256px] mt-[-30px] h-[30px] bg-gray-200 italic mt-[10px]">
         ...
         <div className="w-[80px] rounded-lg flex justify-center item-center ml-[500px] mt-[-30px] h-[30px] bg-gray-200 italic mt-[10px]">
            <input type="text" placeholder='Search Enter Your product' />
