  ...
  return (
    <div className='mt-[25px] ml-[18px]'>
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[256px] mt-[-30px] h-[30px] bg-gray-200 italic mt-[10px]">
         ...
         <div className="w-[400px] rounded-lg flex justify-center item-center ml-[600px] mt-[-30px] h-[30px] bg-gray-400 italic mt-[10px]">
            <input className='bg-gray-200 w-[400px] mx-2' type="text" placeholder='Search Enter Your product' />
