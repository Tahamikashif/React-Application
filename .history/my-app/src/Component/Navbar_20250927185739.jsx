  ...
  return (
    <div className='mt-[25px] ml-[18px]'>
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[256px] mt-[-30px] h-[30px] bg-gray-200 italic mt-[10px]">
         ...
         <div className="w-[400px] rounded-lg flex justify-center item-center ml-[550px] mt-[-30px] h-[30px] bg-gray-400 italic mt-[10px]">
            <input className='bg-gray-200 w-[400px] p-4 text-black' type="text" placeholder='Search Enter Your product' />
