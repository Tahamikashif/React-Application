  ...
  return (
    <div className='mt-[25px] ml-[18px]'>
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[256px] mt-[-30px] h-[30px] bg-gray-200 italic mt-[10px]">
         ...
         <div className="w-[400px] rounded-lg flex justify-center item-center text-black ml-[550px] mt-[-30px] h-[31px]  italic mt-[10px]">
            <input className='bg-gray-200 w-[400px] p-4 rounded-lg ' type="text" placeholder='Search Enter Your product' />
           <IoSearch className='w-[40px] h-[31px] bg-blue-300 ml-[-27px] flex justify-center text-[18px] item-center mt-[8px]' />
        </div>
