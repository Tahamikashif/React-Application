...
const Navbar = () => {
  ...
  return (
    <div className='mt-[25px] ml-[18px]'>
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[70px]  h-[30px] bg-gray-200 italic mt-[10px]">
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[256px] h-[30px] bg-gray-200 italic mt-[10px]">
         ...
         <div className="w-[80px] rounded-lg flex justify-center item-center ml-[348px]  h-[30px] bg-gray-200 italic mt-[10px]">
            <p className='hover:text-gray-500'>New</p>

        </div>
         <div className="w-[80px] rounded-lg flex justify-center item-center ml-[437px]  h-[30px] bg-gray-200 italic mt-[10px]">
            <p className='hover:text-gray-500'>Popular</p>

        </div>
         <div className="w-[400px] rounded-lg flex justify-center item-center text-black ml-[540px] italic  h-[31px]  mt-[10px]">
        ...
        <div className="w-[80px] rounded-lg flex justify-center item-center ml-[964px] h-[31px] bg-gray-200 italic mt-[10px]">
            <p className='hover:text-gray-500'>About</p>

        </div>
         <div className="w-[80px] rounded-lg flex justify-center item-center ml-[1060px] h-[31px] bg-gray-200 italic mt-[10px]">
