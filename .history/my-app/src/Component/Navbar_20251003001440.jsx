...
//           value={searchTerm}
//           onChange={(e) => {setsearchterm(e.target.value);showSuggestion(true)}}
//           onFocus={() => {

//               if (searchTerm.trim())  showSuggestion(true);
...
//     <div className="mt-[25px] ml-[18px] flex items-center gap-4">
//       {/* Menu Items */}
//       {["Men", "Women", "Children", "Brand", "New", "Popular"].map((item) => (
//         <div
//           key={item}
//           className="w-[80px] rounded-lg flex justify-center items-center h-[30px] bg-gray-200 italic"
//         >
//           <p className="hover:text-gray-500">{item}</p>
//         </div>
//       ))}
...
//         {/* Suggestions Box */}
//         {showSuggestion && searchTerm.trim() !== "" && (
//           <div className="absolute z-50 w-[550px] max-h-[400px] overflow-y-auto bg-white shadow-lg rounded-lg mt-2 left-0">
//             {FilterProduct.length > 0 ? (
//               FilterProduct.map((val) => (
//                 <Link
//                   href={`/products/${val.id}`}
...
//         <div
//           key={item}
//           className="w-[80px] rounded-lg flex justify-center items-center h-[31px] bg-gray-200 italic"
//         >
//           <p className="hover:text-gray-500">{item}</p>
//         </div>
//       ))}
