...
const ProductDetail = () => {
  ...
  return (
    <div className="p-6">
      ...
      <p className="italic  ml-[350px] mt-[4px]">Price: Rs {product.price}</p>
      <p className=" ml-[350px] mt-[4px]">Stock:{product.stock}</p>
      <p className=" ml-[350px] mt-[4px]">Discount:{product.dis}</p>
