...
const ProductDetail = () => {
  const { addToCart,cart } = useCart();  // ✅ Correct way
  const { id } = useParams();  
    ...
    <div className="p-6">
      ...
      <div className="ml-[350px] mt-[0px]">
        ...
        >
          ...
          {totalItems >= 0 && (
          <span className="absolute top-2 right-24 bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
            {totalItems}
          </span>
        )}
      </div>
